...
class Subscription
{
	...
	public static function getPlanNameByIndex(int $index){
		return self::$planDataNames[$index];
	}
	
	public static function getPlanDataPriceByName($name){
		return self::$planDataPrice[$name];
	}
	...
	public static function getPlanDataPrice(){
		return self::$planDataPrice;
	}
}
